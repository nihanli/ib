...
namespace IBSampleApp
{
    public partial class IBSampleAppDialog : Form
    {
        ...
        public IBSampleAppDialog()
        {
            ...
            accountManager = new AccountManager(ibClient, accountSelector, accSummaryGrid, accountValuesGrid, accountPortfolioGrid, positionsGrid, orderManager);
        ...
        private void prepareOrders_Click(object sender, EventArgs e)
        {
            accountManager.PrepareStopOrders();
        }

        private async void contractLookup_Click(object sender, EventArgs e)
        {
            accountManager.ContractLookup();
        }
    }
}
